                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <div class="text-center">
                                                ...
                                                <div class="mt-2 align-item-center">
                                                    <h5 class="font-20 d-inline-block mb-0 mr-3 align-self-center">Rp. {{ number_format($datacust['0']->totals) }}</h5>
                                        ...
                                        <div class="carousel-item">
                                            <div class="text-center">
                                                ...
                                                <p class="mb-0 text-muted">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin.</p>
                                                <div class="mt-2 align-item-center">
                                                    <h5 class="font-20 d-inline-block mb-0 mr-3 align-self-center">Rp. {{ number_format($sc->total) }}</h5>
                                                    <a class="btn btn-sm btn-primary text-light mb-2"><i class="mdi mdi-email-outline mr-1"></i>Message</a>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3 class="font-weight-bold">Rp. {{ number_format($total_transaksi,0,',','.') }}</h3>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3 class="font-weight-bold">Rp. {{ number_format($total_transaksi_bulan_ini,0,',','.') }}</h3>
                                        ...
                                        <div class="row">                                            
                                            <div class="col-12 align-self-center">
                                                <div class="text-center">
                                                    ...
                                                    <h2 class="mt-0 font-weight-bold text-dark">Rp. {{ number_format($cml_pml,0,',','.') }}</h2> 
                                                    @if($cml_pml !== 0)
                                        ...
                                        <div class="row">                                            
                                            <div class="col-12 align-self-center">
                                                <div class="text-center">
                                                    ...
                                                    <h2 class="mt-0 font-weight-bold text-dark">Rp. {{ number_format($kry_kdw,0,',','.') }}</h2> 
                                                    @if($kry_kdw !== 0)
                                        ...
                                        <div class="row">                                            
                                            <div class="col-12 align-self-center">
                                                <div class="text-center">
                                                    ...
                                                    <h2 class="mt-0 font-weight-bold text-dark">Rp. {{ number_format($bjg_srg,0,',','.') }}</h2> 
                                                    @if($bjg_srg !== 0)
                                        ...
                                        <div class="row">                                            
                                            <div class="col-12 align-self-center">
                                                <div class="text-center">
                                                    ...
                                                    <h2 class="mt-0 font-weight-bold text-dark">Rp. {{ number_format($doro,0,',','.') }}</h2> 
                                                    @if($doro !== 0)
                                        ...
                                        <div class="row">                                            
                                            <div class="col-12 align-self-center">
                                                <div class="text-center">
                                                    ...
                                                    <h2 class="mt-0 font-weight-bold text-dark">Rp. {{ number_format($kesesi,0,',','.') }}</h2> 
                                                    @if ($kesesi !== 0)
                                                        @if ($kesesi > $kesesi_bulan_lalu)
                                                            <p class="mb-1 text-muted"><span class="text-success">
                                                                <i class="mdi mdi-arrow-up"></i>
                                                                @php
                                                                    $persen = $kesesi * 100 / $kesesi_bulan_lalu      
                                                                @endphp
                                                                {{ round($persen) }}%
                                                                </span> Bulan lalu
                                                            </p>
                                                        @else
                                                            <p class="mb-1 text-muted"><span class="text-danger">
                                                                <i class="mdi mdi-arrow-down"></i>
                                                                @php
                                                                    $persen = $kesesi_bulan_lalu * 100 / $kesesi      
                                                                @endphp
                                                                {{ round($persen) }} %
                                                                </span> Bulan lalu
                                                            </p>    
                                        ...
                                        <div class="row">                                            
                                            <div class="col-12 align-self-center">
                                                <div class="text-center">
                                                    ...
                                                    <h2 class="mt-0 font-weight-bold text-dark">Rp. {{ number_format($png,0,',','.') }}</h2>
                                                    @if ($png !== 0)                                                        
